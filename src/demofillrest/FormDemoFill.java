...
public class FormDemoFill extends javax.swing.JFrame {
    ...
    private FillResponse outFill;
    /**
     * Creates new form DemoFill
     */
    public FormDemoFill() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jBtnCallFill = new javax.swing.JButton();
        ...
        jBtnCallFill.setText("Call Fill");
        jBtnCallFill.setActionCommand("jBtnCallFill");
        jBtnCallFill.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jBtnCallFillActionPerformed(evt);
            }
        });
    ...
    private void jBtnCallFillActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnCallFillActionPerformed
        ...
        outFill= target.request(MediaType.APPLICATION_JSON).get(FillResponse.class);
        
        // lettura campi generali del risultato
        jTxtEsito.setText(String.valueOf(outFill.Norm));
        jTxtCodErr.setText(String.valueOf(outFill.CodErr));
        jTxtNumCand.setText(String.valueOf(outFill.NumCand));
        curCand=0;
        ...
        if (outFill.NumCand>0)
        {
            jTxtRegioneOut.setText(outFill.Output.get(curCand).Detail.Regione) ;
            jTxtComuneOut.setText(outFill.Output.get(curCand).Comune);
            jTxtProvOut.setText(outFill.Output.get(curCand).Prov);
            jTxtCAPOut.setText(outFill.Output.get(curCand).Cap);
            jTxtIstatProvOut.setText(outFill.Output.get(curCand).Detail.IstatProv);
            jTxtIstatComuneOut.setText(outFill.Output.get(curCand).Detail.IstatComune);      
            jTxtFrazioneOut.setText(outFill.Output.get(curCand).Frazione);
            jTxtIndirizzoOut.setText(outFill.Output.get(curCand).Indirizzo);
            jTxtXOut.setText(Double.toString(outFill.Output.get(curCand).Geocod.X));
            jTxtYOut.setText(Double.toString(outFill.Output.get(curCand).Geocod.Y));
        }
    }//GEN-LAST:event_jBtnCallFillActionPerformed
    ...
    private javax.swing.JButton jBtnCallFill;
